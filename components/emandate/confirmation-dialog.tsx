...
const ConfirmationDialog = ({
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="confirmation-dialog max-w-lg p-0 gap-0 border-none overflow-hidden sm:rounded-3xl">
				{/* ── Header ──────────────────────────────────────── */}
				<DialogHeader className="relative px-7 pt-7 pb-5">
					...
					<DialogDescription className="text-muted-foreground text-sm pl-12">
