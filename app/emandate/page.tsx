...
import { User, CreditCard, Shield, CheckCircle, ArrowLeft, ArrowRight } from "lucide-react"
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-4xl">
          ...
          <div className="mb-8 text-center">
            ...
            <h2 className="text-white text-2xl font-semibold mb-2">eMandate Onboarding</h2>
            <p className="text-gray-300">Streamlined debit order registration</p>
          </div>
          ...
          <Card className="stratcol-card border-gray-600">
            <CardHeader>
              ...
              <CardDescription className="text-gray-300">
                {currentStep === 1 && "Select your product and subscription plan"}
                {currentStep === 2 && "Provide your contact information"}
                {currentStep === 3 && "Enter your banking details for debit orders"}
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-yellow-400/10 border border-yellow-400/20 rounded-lg p-4">
                    <p className="text-yellow-200 text-sm">
                      ...
                      Your identity information is encrypted and stored securely in compliance with POPIA regulations.
                    </p>
                  </div>
                </div>
              )}
              ...
              {currentStep === 5 && (
                <div className="space-y-6">
                  <div className="bg-gray-700/50 rounded-lg p-6 space-y-4">
                    <h3 className="text-white font-semibold text-lg">Registration Summary</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span className="text-white ml-2">{formData.subscriptionPlan}</span>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <span className="text-white ml-2">{formData.bankName}</span>
                      </div>
                      <div>
                        <span className="text-gray-400">Account:</span>
                        <span className="text-white ml-2">***{formData.accountNumber.slice(-4)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <Label htmlFor="terms" className="text-white text-sm leading-relaxed">
                        I agree to the Terms and Conditions and authorize StratCol to process debit orders from my
                        account
                      </Label>
                    </div>
                    <div className="flex items-start space-x-3">
