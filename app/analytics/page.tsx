          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Highest revenue generating payment links</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="payments" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Detailed analytics for all payment links</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
          ...
          <TabsContent value="emandate" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">-1.3 min from last month</p>
                </CardContent>
              </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { step: "Product Selection", started: 3847, completed: 3654, rate: "95.0%" },
                    { step: "Contact Details", started: 3654, completed: 3421, rate: "93.6%" },
                    { step: "Banking Details", started: 3421, completed: 3156, rate: "92.3%" },
                    { step: "Verification", started: 3156, completed: 2934, rate: "93.0%" },
                    { step: "Confirmation", started: 2934, completed: 2847, rate: "97.0%" },
                  ].map((step, index) => (
                    <div
                      key={step.step}
          ...
          <TabsContent value="psp" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Detailed analytics by payment method</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    <Card key={psp.psp} className="p-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <div className={`h-4 w-4 rounded-full ${psp.color}`}></div>
                          <div>
                            <h4 className="font-medium">{psp.psp}</h4>
                            <p className="text-sm text-muted-foreground">{psp.transactions} transactions</p>
                          </div>
                        </div>
          ...
          <TabsContent value="revenue" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">+25.4% from last period</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">+12.8% from last period</p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Revenue by payment type and period</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64 flex items-center justify-center border border-dashed border-border rounded-md">
                  <div className="text-center text-muted-foreground">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Highest earning payment methods and products</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
                    { source: "Enterprise Subscriptions", revenue: "R 847,392", percentage: "29.8%", growth: "+22%" },
                    { source: "Professional Plans", revenue: "R 634,156", percentage: "22.3%", growth: "+18%" },
                    { source: "One-time Purchases", revenue: "R 523,789", percentage: "18.4%", growth: "+15%" },
                    { source: "Basic Subscriptions", revenue: "R 456,234", percentage: "16.0%", growth: "+12%" },
                    { source: "Service Fees", revenue: "R 385,821", percentage: "13.5%", growth: "+8%" },
                  ].map((source, index) => (
                    <div
                      key={source.source}
                      className="flex items-center justify-between p-3 border border-border rounded-md"
                    >
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-sm text-green-600">{source.growth}</p>
                      </div>
                    </div>
                  ))}
                </div>
